...
public class CpuInfo {
	...
	private static final String LOG_TAG = "Hummingbird-" + CpuInfo.class.getSimpleName();
		...
		try {
			...
			if (isInitialStatics) {
				...
				if (isPositive(processCpuRatio) && isPositive(totalCpuRatio)) {
					...
					if (traffic == -1) {
						HummingbirdService.bw.write(mDateTime2 + "," + pMemory + "," + percent + "," + fMemory + "," + processCpuRatio + ","
